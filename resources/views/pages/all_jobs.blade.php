            ...
            <div class="row">
             ...
             <div class="create-job">
                ...
                <div class="create-job-content">
                  <div class="job-li-title">Designations</div>
                   <div class="job-li">
                         ...
                         <div class="job-li"><a href="jobsearch.php?area=223"> Data Entry/Computer Operator</a></li></div>



                         <div class="job-li"><a href="jobsearch.php?area=79"> Manager - Accounts</a></li></div>



                         <div class="job-li"><a href="jobsearch.php?area=203"> Pharmaceutical Research</a></li></div>



                         <div class="job-li"><a href="jobsearch.php?area=236"> Machinist</a></li></div>



                         <div class="job-li"><a href="jobsearch.php?area=181"> Supervisor/Officer</a></li></div>



                         <div class="job-li"><a href="jobsearch.php?area=77"> Finance Assistant</a></li></div>



                         <div class="job-li"><a href="jobsearch.php?area=261"> Business Development Executives</a></li></div>
                   ...
                   <div class="job-li">
                           ...
                           <div class="job-li"><a href="jobsearch.php?skill=55"> Management</a></div>

                           <div class="job-li"><a href="jobsearch.php?skill=38"> Production/Manufacturing/Maintenance</a></div>

                           <div class="job-li"><a href="jobsearch.php?skill=52"> mech</a></div>

                           <div class="job-li"><a href="jobsearch.php?skill=54"> NGO/Social Services</a></div>

                           <div class="job-li"><a href="jobsearch.php?skill=46"> test cate</a></div>

                           <div class="job-li"><a href="jobsearch.php?skill=53"> IT - BPO</a></div>
                ...
                <div class="col-md-7">
                    ...
                    <div class=" tab-content">
                        <div class='newpagination'> <span class'current'>1</span>  <a class="link" href="http://74.124.215.220/~demolin/demo/entrepreneur_job_portal/jobsearch_all.html?page=2&">2</a>  <a class="link" href="http://74.124.215.220/~demolin/demo/entrepreneur_job_portal/jobsearch_all.html?page=3&">3</a>  <a class="navlink" href="http://74.124.215.220/~demolin/demo/entrepreneur_job_portal/jobsearch_all.html?page=2&">[Next]</a>  <a class="navlink" href="http://74.124.215.220/~demolin/demo/entrepreneur_job_portal/jobsearch_all.html?page=3&">[Last]</a> </div>                     </div>
...
//alert(id);
    ...
    function sortit(val){
        window.location = "http://74.124.215.220/~demolin/demo/entrepreneur_job_portal/jobsearch_all.html?sortby="+val;
    }

    function sortcount(val){
        window.location = "http://74.124.215.220/~demolin/demo/entrepreneur_job_portal/jobsearch_all.html?view_num="+val;
    }
</script>
