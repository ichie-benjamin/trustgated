        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-10 offset-md-1">
                    <div class="dashboard-box margin-top-0">
                        ...
                        <div class="content with-padding padding-bottom-10">
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="submit-field">
                                        <h5>Employer  <span class="text text-danger">*</span></h5>
                                        <input type="text" name="middle_name" class="with-border">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                ...
                                <div class="col-xl-6">
                                    <div class="submit-field">
                                        ...
                                        <div class="input-with-icon">
                                            <div id="autocomplete-container">
                                                <input id="autocomplete-input" class="with-border" type="text" placeholder="Type Postal Code">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="submit-field">
                                        ...
                                        <div class="input-with-icon">
                                            <div id="autocomplete-container">
                                                <input id="autocomplete-input" class="with-border" type="text" placeholder="Type Phone">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-12">
                        <a href="{{ route('background-verification-2') }}" class="button ripple-effect big margin-top-30"><i class="icon-feather-plus"></i> Next</a>
                    </div>
                </div>
