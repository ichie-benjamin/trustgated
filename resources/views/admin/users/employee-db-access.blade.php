    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            ...
            <div class="br-section-wrapper">
                ...
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10" style="padding-bottom: 50px">{{ $title }} <a href="{{ route('admin.employee.job.access') }}"><button class="btn btn-success" style="float: right">Job Posting Access</button></a></h6>
                ...
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr>
                            ...
                            <th class="wd-10p">Resume Download</th>
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>{{ optional($user->access_plan)->access->no_of_days }}</td>
                                <td>{{ optional($user->access_plan)->access->no_of_resumes }}</td>
                                {{--                                <td>--}}
