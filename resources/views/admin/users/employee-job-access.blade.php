    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            ...
            <div class="br-section-wrapper">
                ...
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10" style="padding-bottom: 50px">{{ $title }} <a href="{{ route('admin.employee.db.access') }}"><button class="btn btn-success" style="float: right">Database Access</button></a></h6>
                ...
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr>
                            ...
                            <th class="wd-10p">Usage Days</th>
                            <th class="wd-10p">No of Jobs</th>
...
{{--                            <th class="wd-10p">Action</th>--}}
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>{{ $user->job_plan->product->name }}</td>

                                <td>{{ optional($user->job_plan)->product->no_of_days }}</td>
                                <td>{{ optional($user->job_plan)->product->no_of_jobs }}</td>
{{--                                <td>--}}
