...
<div class="br-mainpanel">
      ...
      <div class=" pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30" style="position:center;" >
        <h4 class=" tx-gray-800 mg-b-5">Add Package</h4>
</div>
...
<div class="br-pagebody">
    <div class="br-section-wrapper">
        ...
        <div class="row mg-t-10">
            <div class="col-xl-12">
                <form action="{{ route('admin.deliveryPackages.store') }}" method="POST">
                    @csrf
                    <div class="form-layout form-layout-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                <input type="text" class="form-control" placeholder="Package" required name="name">
                            </div>
                        </div><!-- row -->
