...
<div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{ route('admin.locations.index') }}"> Categories</a>
                        ...
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <input class="form-control" value="{{ old('name', optional($location)->name) }}" type="text" name="name" required placeholder="Enter Name">
                                </div>
                            </div>
                        </div><!-- row -->
