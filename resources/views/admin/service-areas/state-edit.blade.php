                ...
                <div class="col-xl-12">
                    <form action="{{ route('admin.states.update', $state) }}" method="POST">
                        ...
                        <div class="form-layout form-layout-4">
                            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Add State</h6>
                            <div class="row">
...
{{--                                        <option label="Choose country"></option>--}}
                            ...
                            <div class="row">
                                <label class="col-sm-4 form-control-label">Add State: <span class="tx-danger">*</span></label>
                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                    <input type="text" class="form-control" placeholder="Enter State Name" name="name" value="{{ $state->name }}">
                                </div>
                            </div><!-- row -->
                            ...
                            <div class="form-layout-footer mg-t-30">
                                ...
                                <a class="btn btn-secondary" href="{{  route('admin.states.index') }}">Cancel</a>
