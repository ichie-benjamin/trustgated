...
<div class="br-mainpanel">
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Cities List</h4>
        <p class="mg-b-0"></p>
    </div>
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10" style="padding-bottom: 50px">City List <a
                    href="{{ route('admin.cities.create') }}"><button class="btn btn-success" style="float: right"> Add
                        New City</button></a></h6>
            ...
            <div class="table-wrapper">
                <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $i++ }}</td>
                            <td>{{ $city->lga->state->country->name }}</td>
                            <td>{{ $city->lga->state->name }}</td>
                            <td>{{ $city->lga->name }}</td>
                            <td>{{ $city->name }}</td>
                            <td>
