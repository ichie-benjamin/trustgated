    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <div class="row mg-t-10">
                <div class="col-xl-12">
                    <form action="{{ route('admin.lgas.update', $lga) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        <div class="form-layout form-layout-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mg-t-10 mg-b-10">
                                    <select class="form-control select2" data-placeholder="Choose country"
                                        ...
                                        <option value="{{ $country->id }}" @if($lga->state->country_id == $country->id) selected @endif>{{ $country->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div><!-- col-4 -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mg-t-10 mg-b-10">
                                    <select class="form-control select2" data-placeholder="Choose state"
                                        ...
                                        <option value="{{ $state->id }}" @if($lga->state_id == $state->id) selected @endif>{{ $state->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div><!-- col-4 -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                    <input type="text" class="form-control" placeholder="Enter lga" name="name" value="{{ $lga->name }}">
                                </div>
                            </div><!-- row -->
