...
{{--        </a><!-- br-menu-link -->--}}
        ...
        <a href="{{ route('admin.dbproducts.index') }}" class="br-menu-link">
            <div class="br-menu-item">
        ...
        <a href="{{ route('admin.background.form.index') }}" class="br-menu-link">
            <div class="br-menu-item">
                <i class="menu-item-fa fa fa-user tx-22"></i>
                <span class="menu-item-label"> Verification Packages User Forms</span>
            </div><!-- menu-item -->
        </a><!-- br-menu-link -->
