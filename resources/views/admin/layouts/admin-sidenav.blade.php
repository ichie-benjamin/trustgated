...
{{--            <li class="nav-item"><a href="{{ route('admin.zones.index') }}" class="nav-link">Add Zone</a></li>--}}
{{--            <li class="nav-item"><a href="{{ route('admin.zoneLocations.index') }}" class="nav-link">Add Zone Location</a></li>--}}
{{--            --}}{{-- <li class="nav-item"><a href="<?php echo url('territories-list.php'); ?>" class="nav-link">Add Territories</a></li> --}}
{{--            --}}{{-- <li class="nav-item"><a href="{{ route('zoneServiceAreas.index') }}" class="nav-link">Add Service Area</a></li> --}}
{{--            --}}{{-- <li class="nav-item"><a href="<?php echo url('service-area-city-list'); ?>" class="nav-link">Add Service Area by Cities</a></li> --}}

{{--            --}}{{-- <li class="nav-item"><a href="<?php echo url('service-area-setting.php'); ?>" class="nav-link">Setup Service Area</a></li> --}}
{{--            <li class="nav-item"><a href="{{ route('admin.zoneWeightPrices.index') }}" class="nav-link">Price Setup</a></li>--}}
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto active" id="contacts" role="tabpanel">
            ...
            <div class="contact-list pd-x-10">
                <a href="#" class="contact-list-link new">
                    <div class="d-flex">
                        <div class="pos-relative">
                            <img src="http://localhost/afiaanyi-logistics/img/img2.jpg" class="wd-40 rounded-circle" alt="">
                ...
                <a href="#" class="contact-list-link">
                    <div class="d-flex">
                        <div class="pos-relative">
                            <img src="http://localhost/afiaanyi-logistics/img/img6.jpg" class="wd-40 rounded-circle" alt="">
                            <div class="contact-status-indicator bg-success"></div>
                        </div>
                        <div class="contact-person">
