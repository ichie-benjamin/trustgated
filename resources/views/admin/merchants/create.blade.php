...
@section('content')
    ...
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Add Merchant</h4>
    </div>
            ...
            <div class="form-layout form-layout-4">
                ...
                <form action="{{ route('admin.merchants.store') }}" method="POST">
                    ...
                    <div class="row mg-t-20">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <input id="nature_of_business" type="text" placeholder="Nature of Business" class="form-control @error('nature_of_business') is-invalid @enderror" name="nature_of_business" value="{{ old('nature_of_business') }}" required autocomplete="nature_of_business" autofocus>
                    ...
                    <div class="row mg-t-20">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <select name="delivery_category_id" class="form-control select2" data-placeholder="Choose Delivery Package" required>
                            ...
                            <select name="billing_category_id" class="form-control select2" data-placeholder="Choose Delivery Payment Mode" required>
                                <option label="Choose Delivery Package"></option>
                                    @foreach ($billingCategories ?? [] as $paymentMode)
                                        <option value="{{ $paymentMode->id }}" @if ($paymentMode->id == old('delivery_category_id')) selected @endif>{{ $paymentMode->name }}</option>    
                                    @endforeach
                            </select>
                        </div>
                    </div>
