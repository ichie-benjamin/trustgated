...
<div class="br-mainpanel">
      ...
      <div class=" pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30" style="position:center;">
        <h4 class=" tx-gray-800 mg-b-5">Update Price</h4>
</div>
...
<div class="br-pagebody">
    <div class="br-section-wrapper">
        ...
        <div class="row mg-t-10">
            <div class="col-xl-12">
                <form action="{{ route('admin.zoneWeightPrices.update', $zoneWeightPrice) }}" method="POST">
                    @csrf
                    @method('PATCH')
                <div class="form-layout form-layout-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-b-10">
                            <select class="form-control select2" data-placeholder="Choose Zone" name="zone_id" required>
                                ...
                                <option @if($zoneWeightPrice->zone_id == $zone->id) selected @endif value="{{ $zone->id }}">{{ $zone->name }}</option>
                                @endforeach
                            </select> </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-b-10">
                            <select class="form-control select2" data-placeholder="Choose weight" name="weight_id" required>
                                ...
                                <option value="{{ $weight->id }}" @if($zoneWeightPrice->weight_id == $weight->id) selected @endif>{{ $weight->name }}</option>
                                @endforeach
                            </select> </div>
                    </div><!-- col-4 -->
                    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10"></h6>
                    <div class="row">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <input type="number" class="form-control" placeholder="Enter Price" name="price" required value="{{ $zoneWeightPrice->price }}">
                        </div>
                    </div><!-- row -->
