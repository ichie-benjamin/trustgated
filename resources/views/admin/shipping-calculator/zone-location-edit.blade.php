...
<div class="br-mainpanel">
      ...
      <div class=" pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30" style="position:center;" >
        <h4 class=" tx-gray-800 mg-b-5">Update Zone Mapping</h4>
</div>
...
<div class="br-pagebody">
    <div class="br-section-wrapper">
        ...
        <div class="row mg-t-10">
            <div class="col-xl-12">
                <form action="{{ route('admin.zoneLocations.update', $zoneLocation) }}" method="POST">
                    @csrf
                    @method('PATCH')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 mg-t-10 mg-b-10">
                                <select class="form-control select2" data-placeholder="Choose Zone" required name="zone_id">
                                    ...
                                    <option value="{{ $zone->id }}" @if($zoneLocation->zone_id == $zone->id) selected @endif>{{ $zone->name }}</option>
                                    @endforeach
                                </select> </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 mg-t-10 mg-b-10">
                                <select class="form-control select2" data-placeholder="Choose origin" name="origin" required>
                                    ...
                                    <option value="{{ $city->id }}" @if($zoneLocation->origin == $city->id) selected @endif>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 mg-t-10 mg-b-10">
                                <select class="form-control select2" data-placeholder="Choose destination" name="destination" required>
                                    ...
                                    @foreach ($cities as $city)
                                    <option value="{{ $city->id }}" @if($zoneLocation->destination == $city->id) selected @endif>
                                        {{ $city->name.' - '.$city->lga->name.', '.$city->lga->state->name.' '.$city->lga->state->country->name }}</option>
                                    @endforeach
                                </select> </div>
                        </div><!-- col-4 -->
