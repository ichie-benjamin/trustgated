    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10" style="padding-bottom: 50px">Zone List <a
                    href="{{ route('admin.zones.create') }}"><button class="btn btn-success" style="float: right"> Add New
                        Zone</button></a></h6>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{  route('admin.zones.destroy', $zone) }}" method="POST">
                                    ...
                                    <a href="{{ route('admin.zones.edit', $zone) }}" class="btn btn-danger"
