    ...
    <div class="col-lg-10 offset-md-1">
        <div class="dashboard-box margin-top-0">
            ...
            <div class="headline">
                ...
                <p> Employment Details - Step 2 of 3</p>
                <div class="progress">
        ...
        <div class="col-xl-12">
            <a href="{{ route('background-verification-3') }}" class="button ripple-effect big margin-top-30"><i class="icon-feather-plus"></i> Next</a>
        </div>
    </div>
