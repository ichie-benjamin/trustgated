...
<script type="text/javascript">
    function radioemp()
    {
        ...
        if(document.getElementById("emptype2").checked==true)
        {

            document.getElementById('durTo').style.display='block';

        }
        else if(document.getElementById("emptype2").checked==false)
        {

            document.getElementById('durTo').style.display='none';
