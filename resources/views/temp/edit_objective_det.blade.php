        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9" >
                    ...
                    <form name="register" id="register" method="post" action="" class="form-horizontal m10">
                        <div class="row" >
                            ...
                            <div class="col-sm-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <textarea style="width:450px; height:50px;" name="objective" id="objective" onkeyup="chkkabuse(this.id);" class="form-control"></textarea>
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-7">
                                    ...
                                    <div class="col-sm-3"><input type="submit" name="save1"class="btn-blue btn" value="Save" onClick="javascript: return objval();"></div>
...
//alert(val);
        ...
        if(obj=="")
        {
            ...
            document.getElementById("objInfo").innerHTML='<font color="#F00" style="font-size:11px;">Enter the Summary Details</font>';
