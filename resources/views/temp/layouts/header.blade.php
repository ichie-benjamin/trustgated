                ...
                <div class="col-sm-12">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse-2">
                        <ul class="nav navbar-nav navbar-left  clearfix sss">
                            <li>Browse jobs :</li>
                            <li class="active"><a style="font-size: 15px" href="{{ route('all_jobs') }}"><i class="fa fa-briefcase" aria-hidden="true"></i> All jobs</a></li>
                            <li class=""><a style="font-size: 15px" href="{{ route('company_job') }}"><i class="fa fa-building" aria-hidden="true"></i> Job by Company</a></li>
                            <li class=""><a style="font-size: 15px" href="{{ route('category_job') }}"><i class="fa fa-trello" aria-hidden="true"></i> Job by Category</a></li>
                            <li class=""><a style="font-size: 15px" href="{{ route('job_by_area') }}"><i class="fa fa-map-marker" aria-hidden="true"></i> Job by Location</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                </div> <!--col-sm-12-->
            </div><!--container-->
